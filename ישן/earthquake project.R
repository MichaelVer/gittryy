...
hist(EarthquakeOld$Depth , breaks = 100 , xlim = c(0,150) , main = "Distrebution of Depth" , xlab = "Depth")

hist(Earthquake$Magnitude , breaks = 100 ,xlab = "Magnitude" , main = "Distrebution of magnitude" )
